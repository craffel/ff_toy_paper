...
\end{equation}
This form of integration has been used to collapse the temporal dimension of audio \cite{dieleman2014recommending} and text document \cite{lei2015molding} sequences.
...
In fact, the current state-of-the-art system for document classification still uses order-agnostic sequence integration \cite{lei2015molding}.
