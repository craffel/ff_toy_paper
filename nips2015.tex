...
For example, in Joachims' seminal paper on text document categorization, he posits that ``word stems work well as representation units and that their ordering in a document is of minor importance for many tasks'' \cite{joachims1998text}.
