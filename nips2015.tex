...
%    $T_0$ & 5e1 & 1e2 & 5e2 & 1e3 & 5e3 & 5e1 & 1e2 & 5e2 & 1e3 & 5e3 \\
    \cmidrule(r){2-6}
    \cmidrule(r){7-11}
    Attention & 1 & 1 & 2 & 2 & 8 & 1 & 3 & 25 & 58 & -- \\
    Unweighted & 1 & 2 & 2 & 4 & \textcolor{gray}{18.5\%} & 18 & 5 & 48 & 94 & -- \\
    \bottomrule
  \end{tabular}
...
Using the attention mechanism of Equation \ref{eq:ffattention}, on held-out test sets of 1000 sequences, our model achieved 99.1\% accuracy on the addition task and --\% on the multiplication task.
