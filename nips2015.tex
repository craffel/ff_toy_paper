...
Recent advances in optimization techniques \cite{martens2011learning,sutskever2013importance}, initialization methods \cite{sutskever2013importance,jaegar2012long,mikolov2014learning,le2015simple}, and model architectures \cite{cho2014learning,hochreiter1997long} have facilitated the success of RNNs in a wide variety of fields, including machine translation \cite{cho2014learning,bahdanau2014neural,sutskever2014sequence}, speech recognition \cite{graves2012supervised,cho2015describing,sak2014long}, handwriting recognition \cite{graves2012supervised}, and text generation \cite{graves2013generating,pascanu2012difficulty,mikolov2014learning,le2015simple}.
...
Because the same function $f$ is applied repeatedly over time, the gradient with respect to its parameters can easily explode or vanish \cite{pascanu2012difficulty,hochreiter1997long,bengio1994learning}.
The use of gating architectures \cite{hochreiter1997long,cho2014learning}, sophisticated optimization techniques \cite{sutskever2013importance,jaegar2012long,le2015simple}, gradient clipping \cite{pascanu2012difficulty,graves2013generating}, and/or careful initialization \cite{sutskever2013importance,jaegar2012long,mikolov2014learning,le2015simple} can help mitigate this issue.
However, these approaches do not solve this problem, and as a result RNNs are in practice typically only applied in tasks where sequential dependencies span at most hundreds of time steps \cite{martens2011learning,sutskever2013importance,le2015simple,hochreiter1997long}.
